 ...
 */
export declare const DIAGRAM_TYPES: readonly DiagramType[];
export declare function isDiagramType(value: unknown): value is DiagramType;
/**
 ...
 */
export declare const DIAGRAM_TYPE_TITLES: Record<DiagramType, string>;
export declare function isNodeDatum(value: unknown): value is NodeDatum;
export declare function isEdgeDatum(value: unknown): value is EdgeDatum;
