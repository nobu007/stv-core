...
export function getQualityTier(score) {
    if (score >= QUALITY_TIER_BARS.excellent)
        return 'excellent';
    if (score >= QUALITY_TIER_BARS.good)
        return 'good';
    if (score >= QUALITY_TIER_BARS.fair)
        return 'fair';
    return 'poor';
}
...
export function getQualityColorClass(score) {
...
export function getQualityBadgeVariant(score) {
...
export function getQualityTierLabel(score) {
