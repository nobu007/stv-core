 ...
 */
export declare function computePercentiles(sorted: number[]): Percentiles;
/**
 ...
 */
export declare function percentileCeil(sorted: number[], fraction: number): number;
/**
 ...
 */
export declare function percentChange(current: number, baseline: number): number;
/**
 ...
 */
export declare function heapUsageRatio(heapUsed: number, heapTotal: number): number;
/**
 ...
 */
export declare function heapUsagePercent(heapUsed: number, heapTotal: number): number;
/**
 ...
 */
export declare function safeSum(values: readonly number[], fallback?: number): number;
/**
 ...
 */
export declare function safeMean(values: readonly number[], fallback?: number): number;
/**
 ...
 */
export declare function safeMax(values: readonly number[], fallback?: number): number;
/**
 ...
 */
export declare function safeMin(values: readonly number[], fallback?: number): number;
/**
