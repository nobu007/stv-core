...
/** Hiragana ぀-ゟ */
export const HIRAGANA = { start: 0x3040, end: 0x309f };
/** Katakana ゠-ヿ */
export const KATAKANA = { start: 0x30a0, end: 0x30ff };
/** Katakana Phonetic Extensions ㇰ-㿿 (used e.g. for Ainu) */
export const KATAKANA_PHONETIC_EXTENSIONS = { start: 0x31f0, end: 0x31ff };
/** CJK Unified Ideographs 一-鿿 */
export const CJK_UNIFIED_IDEOGRAPHS = { start: 0x4e00, end: 0x9fff };
/** CJK Extension A 㐀-䶿 */
export const CJK_EXTENSION_A = { start: 0x3400, end: 0x4dbf };
/** CJK Compatibility Ideographs 豈-﫿 */
export const CJK_COMPATIBILITY_IDEOGRAPHS = { start: 0xf900, end: 0xfaff };
/** Hangul Syllables 가-힣 */
export const HANGUL_SYLLABLES = { start: 0xac00, end: 0xd7af };
/**
 ...
 */
export const FULLWIDTH_WIDE_FORMS = { start: 0xff01, end: 0xff60 };
...
export const JAPANESE_TEXT_RANGES = [
    ...KANA_RANGES,
 ...
 */
export const WIDE_DISPLAY_RANGES = [
    ...CJK_TOKEN_RANGES,
    FULLWIDTH_WIDE_FORMS,
];
// ── Helpers ──────────────────────────────────────────────────────
/** True when `code` falls inside any of `ranges`. */
export function charInRanges(code, ranges) {
...
export function charClassSource(ranges) {
...
export function buildCharClassRegex(ranges, flags = '') {
