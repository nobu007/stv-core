 ...
 * ```
 */
export declare function sanitizeFinite(value: unknown, defaultValue?: number): number;
/**
 ...
 * ```
 */
export declare function sanitizeDiagramType(value: unknown, defaultValue?: DiagramType): DiagramType;
/**
 ...
 * ```
 */
export declare function clampFinite(value: unknown, min: number, max: number): number;
/**
 ...
 * ```
 */
export declare function safeToLocaleString(value: unknown, defaultValue?: string): string;
