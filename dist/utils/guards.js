 ...
 */
import { isDiagramType } from '../types/diagram.js';
/**
 ...
 * ```
 */
export function sanitizeFinite(value, defaultValue = 0) {
 ...
 * ```
 */
export function sanitizeDiagramType(value, defaultValue = 'general') {
 ...
 * ```
 */
export function safeToLocaleString(value, defaultValue = '0') {
    if (typeof value === 'number' && Number.isFinite(value))
